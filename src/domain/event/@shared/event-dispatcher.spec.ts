...
import EnviaConsoleLog1Handler from "../customer/handler/send-mensage-to-log";
import CustomerCreatedEvent from "../customer/customer-created.event";
import EnviaConsoleLog2Handler from "../customer/handler/send-mensage-to-log-2";
import Customer from "../../entity/customer";
import Address from "../../entity/address";
import AddressChangedEvent from "../customer/address-changed.event";
import EnviaConsoleLog3Handler from "../customer/handler/send-mensage-to-log-3";
...
describe("Domain events tests", () => {
    ...
    it("should notify when address is changed", () => {
        ...
        const address = new Address("1", "Street", "City", "State", "Country", "ZipCode");
